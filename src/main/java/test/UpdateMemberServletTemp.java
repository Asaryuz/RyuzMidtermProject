...
@WebServlet("/UpdateMemberServletTemp")
public class UpdateMemberServletTemp extends HttpServlet {
...
//			Member mem = new Member(null, userId, password, name, phoneNo, experience, date, registerTime);
		...
		response.sendRedirect(request.getContextPath() + "/QueryAllMembersServletTemp");
